...
| [0044](0044-p4-provider-ports-vmspec-and-launcher.md) | P4 — the `VmSpec`/`Extensions` provider port, `VmProvider`, `StateRepository<T>`, and `delonix-launcher` | **Proposed 2026-09-18** — closes ADR-0040's seven `arch_fitness.py` P4 exceptions; D6's `StateRepository<T>` spike done for `Store<Container>` (`docs/discovery/56_P4_D6_STATE_REPOSITORY_SPIKE.md`); four more spikes required before Accepted |

...
=======
>>>>>>> origin/integra/resources-advise
...
=======
>>>>>>> origin/integra/system-regulate
...
- **Nenhum modelo foi medido.** O arnês está provado contra um modelo-stub, que
  serve para mostrar que o marcador distingue certo de errado — não há Ollama
  instalado nesta máquina, e instalá-lo era decisão do dono dela. Os números por
  modelo saem quando alguém correr o comando.

...
| **M11** | Performance comprovada | `IN_PROGRESS` | **Recontagem FEITA a 2026-08-25** com o `scripts/bench.sh`: docker **299 ms**, podman **277 ms**, delonix **80 ms** no default (mediana de 10, dispersão publicada). O harness recusa-se a correr em bancada carregada — e recusou à primeira tentativa, com load 55-72. | thresholds de regressão em CI; medir 4b/4c noutra bancada para atribuir a diferença | `bench.sh` + 2 checks E2E | M01 | médio | #125, #126 | 3 de 4 |

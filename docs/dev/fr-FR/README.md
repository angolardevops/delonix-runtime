...
| **Opérer et déboguer** | [Diagnostic des problèmes](troubleshooting.md) | Un index par symptôme : le texte littéral qu’un gate ou une exécution réelle affiche, et où lire le correctif |

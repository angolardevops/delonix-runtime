...
décrits dans [02 — Cloner, construire et tester](02-build-and-test.md).
...
crate et la direction autorisée sont listées dans [05 — Architecture](05-architecture.md). Ce que
...
- **Validez contre le binaire**, pas contre la source : `./target/debug/delonix <group> <command> --help`
  et une exécution réelle avec les racines d'état isolées (voir [02](02-build-and-test.md#isolating-the-engines-state)).

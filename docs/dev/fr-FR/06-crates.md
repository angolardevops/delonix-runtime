...
- Trouvez le crate responsable de ce que vous voulez modifier (la couche d'abord ; voir
  [05 — Architecture](05-architecture.md) pour savoir pourquoi les couches existent et dans quelle
...
(les exceptions déclarées sont listées dans [05](05-architecture.md)).
...
couches déclarée (voir [05](05-architecture.md)) — et `delonix-model`, dans l'`Error` duquel ses

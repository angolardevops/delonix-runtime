...
KVM), commencez par [04 — Initiation au cloud native](04-cloud-native-primer.md).
...
d’un crate d’interface. Voir : [05 — Les couches](05-architecture.md#layers-and-the-allowed-direction),
...
[10 — Quand écrire un ADR](10-contributing-workflow.md#when-to-write-an-adr).
...
[04 — Réconciliation déclarative](04-cloud-native-primer.md#48-declarative-reconciliation).
...
[04 — cgroups v2 et délégation](04-cloud-native-primer.md#42-cgroups-v2-and-delegation),
[01 — Délégation de cgroup](01-environment.md#cgroup-delegation-some-limits-are-refused-others-are-not-enforced).
...
[04 — Réseau des containers](04-cloud-native-primer.md#45-container-networking).
...
[05 — Où en est la restructuration](05-architecture.md#where-the-restructuring-stands),
...
[03 — Erreurs](03-rust-primer.md#32-errors-one-error-and-exit-codes-derived-from-its-type).
...
[05 — Identité et frontières du moteur](05-architecture.md#engine-identity-and-boundaries),
[10 — Règles d’architecture](10-contributing-workflow.md#architecture-rules-the-gates-enforce).
...
[10 — Langue](10-contributing-workflow.md#language-english-in-the-code-lang-01).
...
**Overlay / lowerdir**). Voir : [05 — Les couches](05-architecture.md#layers-and-the-allowed-direction),
[ADR-0040](../../adr/0040-engine-restructuring-layers-ports-node-contract.md).
...
Cloud Hypervisor. Voir : [09 — Construire des microVMs](09-microvm-setup.md),
...
[04 — Virtualisation](04-cloud-native-primer.md#47-virtualization-kvm-virtio-cloud-hypervisor-libvirt-cloud-init).
...
[04 — Images OCI](04-cloud-native-primer.md#44-oci-images-content-addressed-storage-and-overlayfs).
...
[03 — Les traits comme ports](03-rust-primer.md#33-traits-as-ports-vmbackend-and-the-backend-registry).
...
code — et exige un ADR. Voir : [06 — Providers](06-crates.md#providers),
...
[07 — Le réconciliateur déclaratif](07-system-design-interview.md#55-the-declarative-reconciler-without-a-state-file).
...
Voir : [04 — Namespaces Linux et fonctionnement rootless](04-cloud-native-primer.md#41-linux-namespaces-and-rootless-operation).
...
[07 — Réseau](07-system-design-interview.md#52-networking-pin-control-slirp-nftables).
...
[01 — Exigences du noyau](01-environment.md#kernel-requirements).

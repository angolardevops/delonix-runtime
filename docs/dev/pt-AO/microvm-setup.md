...
real e já reiniciou cargas reais antes (ver [Clonar, compilar e testar](build-and-test.md)). Uma VM Cloud Hypervisor
...
- Implementa o `VmBackend` **no seu próprio crate** se ele falar com uma API remota (o crate do motor
  ...
  `scripts/arch_fitness.py` (ver [Arquitectura](architecture.md)).

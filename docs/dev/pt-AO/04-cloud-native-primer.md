...
AppArmor — ver [1. Ambiente](01-environment.md) para as consequências práticas.
...
- As VMs na SDN rootless recebem um lease DHCP derivado do seu MAC: `dhcp_lease_ip` em
  `crates/adapters/delonix-sdn/src/infra.rs`.
- Configuração prática e armadilhas conhecidas do host: [9. Configurar microVMs](09-microvm-setup.md).
...
[3. Introdução ao Rust §3.8](03-rust-primer.md#38-concurrency-and-shared-state)), existe um processo
...
consequências — boas e más — são discutidas em [5. Arquitectura](05-architecture.md) e

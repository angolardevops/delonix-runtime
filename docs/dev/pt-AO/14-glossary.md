...
OCI, CRI, CNI, KVM), começa por [04 — Introdução ao cloud native](04-cloud-native-primer.md).
...
contexto, nunca de um crate de interface. Ver: [05 — Camadas](05-architecture.md#layers-and-the-allowed-direction),
...
[10 — Quando escrever um ADR](10-contributing-workflow.md#when-to-write-an-adr).
...
[04 — Reconciliação declarativa](04-cloud-native-primer.md#48-declarative-reconciliation).
...
[05 — Estado em disco](05-architecture.md#state-on-disk).
...
[04 — cgroups v2 e delegação](04-cloud-native-primer.md#42-cgroups-v2-and-delegation),
[01 — Delegação de cgroup](01-environment.md#cgroup-delegation-some-limits-are-refused-others-are-not-enforced).
...
[04 — Rede de containers](04-cloud-native-primer.md#45-container-networking).
...
[05 — Em que ponto está a reestruturação](05-architecture.md#where-the-restructuring-stands),
...
[03 — Erros](03-rust-primer.md#32-errors-one-error-and-exit-codes-derived-from-its-type).
...
dívida. Ver:
[05 — Identidade e fronteiras do motor](05-architecture.md#engine-identity-and-boundaries),
[10 — Regras de arquitectura](10-contributing-workflow.md#architecture-rules-the-gates-enforce).
...
[10 — Língua](10-contributing-workflow.md#language-english-in-the-code-lang-01).
...
imagem** (ver **Overlay / lowerdir**). Ver: [05 — Camadas](05-architecture.md#layers-and-the-allowed-direction),
[ADR-0040](../../adr/0040-engine-restructuring-layers-ports-node-contract.md).
...
backend Cloud Hypervisor. Ver: [09 — Construir microVMs](09-microvm-setup.md),
...
[04 — Virtualização](04-cloud-native-primer.md#47-virtualization-kvm-virtio-cloud-hypervisor-libvirt-cloud-init).
...
[04 — Imagens OCI](04-cloud-native-primer.md#44-oci-images-content-addressed-storage-and-overlayfs).
...
[03 — Traits como portas](03-rust-primer.md#33-traits-as-ports-vmbackend-and-the-backend-registry).
...
código — e precisa de um ADR. Ver: [06 — Providers](06-crates.md#providers),
...
[07 — O reconciliador declarativo](07-system-design-interview.md#55-the-declarative-reconciler-without-a-state-file).
...
explícito. Ver:
[04 — Namespaces Linux e operação rootless](04-cloud-native-primer.md#41-linux-namespaces-and-rootless-operation).
...
[07 — Rede](07-system-design-interview.md#52-networking-pin-control-slirp-nftables).
...
(`DELONIX_NET_RUNTIME_DIR`). Define sempre os dois quando testas. Ver:
`bins/delonix-runtime-bin/src/cmd/util.rs::state_root`,
[05 — Estado em disco](05-architecture.md#state-on-disk),
[02 — Isolar o estado do motor](02-build-and-test.md#isolating-the-engines-state).
...
[01 — Requisitos do kernel](01-environment.md#kernel-requirements).
...
[04 — Namespaces Linux](04-cloud-native-primer.md#41-linux-namespaces-and-rootless-operation),
...
[10 — Um worktree por tarefa](10-contributing-workflow.md#one-worktree-per-task).

...
on an interface crate. See: [Layers](architecture.md#layers-and-the-allowed-direction),
...
[When to write an ADR](contributing-workflow.md#when-to-write-an-adr).
...
[State on disk](architecture.md#state-on-disk).
...
[cgroups v2 and delegation](cloud-native-primer.md#42-cgroups-v2-and-delegation),
[cgroup delegation](environment.md#cgroup-delegation-some-limits-are-refused-others-are-not-enforced).
...
[Container networking](cloud-native-primer.md#45-container-networking).
...
[Errors](rust-primer.md#32-errors-one-error-and-exit-codes-derived-from-its-type).
...
[Engine identity and boundaries](architecture.md#engine-identity-and-boundaries),
[Architecture rules](contributing-workflow.md#architecture-rules-the-gates-enforce).
...
[Language](contributing-workflow.md#language-english-in-the-code-lang-01).
...
**Overlay / lowerdir**). See: [Layers](architecture.md#layers-and-the-allowed-direction),
[ADR-0040](../adr/0040-engine-restructuring-layers-ports-node-contract.md).
...
backend. See: [Building microVMs](microvm-setup.md),
...
[Virtualization](cloud-native-primer.md#47-virtualization-kvm-virtio-cloud-hypervisor-libvirt-cloud-init).
...
[OCI images](cloud-native-primer.md#44-oci-images-content-addressed-storage-and-overlayfs).
...
[The declarative reconciler](system-design-interview.md#55-the-declarative-reconciler-without-a-state-file).
...
See: [Linux namespaces and rootless operation](cloud-native-primer.md#41-linux-namespaces-and-rootless-operation).
...
[Networking](system-design-interview.md#52-networking-pin-control-slirp-nftables).
...
[Kernel requirements](environment.md#kernel-requirements).
...
[Linux namespaces](cloud-native-primer.md#41-linux-namespaces-and-rootless-operation),

...
The workspace has **21 crates** and ships **4 binaries** (`delonix`, `delonix-cri`, `delonix-mcp`, `delonix-mgmt`).
...
|---|---|
| **Send a first PR** (a CLI fix, a docs fix, a small feature) | [01](01-environment.md) → [02](02-build-and-test.md) → [10](10-contributing-workflow.md) → [06](06-crates.md) for the crate you touch |
| **Understand the engine in depth** | [03](03-rust-primer.md) → [04](04-cloud-native-primer.md) → [05](05-architecture.md) → [06](06-crates.md) → [07](07-system-design-interview.md) |

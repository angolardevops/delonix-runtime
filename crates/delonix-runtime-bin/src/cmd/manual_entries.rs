...
pub static ENTRIES: &[Entry] = &[
    ...
    Entry {
        ...
        see_also: &["cluster create", "image ls", "build", "get"],
    },
    Entry {
    ...
    Entry {
        ...
        see_also: &["image remove", "image ls", "container prune", "system prune"],
    },
    Entry {
        path: "image describe",
        group: "Inspect",
    ...
    Entry {
        ...
        see_also: &["image push", "image ls", "image remove"],
    },
    Entry {
        path: "image export",
        group: "Storage",
    ...
    Entry {
        ...
        examples: &[
            ...
            ("...or a framework version for `laravel`/`nextjs`/`nestjs`/`node`", "delonix init -t laravel -v 11 myapp"),
    ...
    Entry {
        ...
        examples: &[
            ...
            ("pin a Django project to an exact major.minor line", "delonix stack init -t django -v 5.2"),
            ("pin a Laravel project to a framework major", "delonix stack init -t laravel -v 11"),
            ("pin the Go toolchain a template builds against", "delonix stack init -t go -v 1.22"),
        ],
    ...
    Entry {
        ...
        group: "Inspect",
        examples: &[
            ("what archives are here, and what each one holds", "delonix backup ls"),
            ("the ones on the NAS", "delonix backup ls --from /srv/backups"),
            ("only this resource", "delonix backup ls --kind container --name db"),
        ],
    ...
    Entry {
        ...
        see_also: &["backup ls", "backup restore"],
    },
    Entry {
        path: "backup restore",
        group: "Configure",
    ...
    Entry {
        ...
        see_also: &["system prune", "image ls", "volume ls", "system info"],
    },
    Entry {
        path: "system events",
        group: "Inspect",
    ...
    Entry {
        ...
        examples: &[
            ...
            ("un-register a share — the data on the parent is PRESERVED", "delonix volume rm app-data"),
            ("un-register and delete the underlying subdirectory as well", "delonix volume rm app-data --purge-data"),
        ],
        see_also: &["volume ls", "volume snapshot create", "container rm", "volume prune"],
    },
    Entry {
        path: "volume prune",
        group: "Maintenance",
    ...
    Entry {
        ...
        see_also: &["volume inspect", "volume ls", "volume rm"],
    },
    Entry {
        path: "volume inspect",
        group: "Inspect",
        ...
        see_also: &["volume describe", "volume ls", "volume create"],
    },
    Entry {
        path: "volume ls",
        group: "Inspect",
        examples: &[
            ...
            ("every namespace at once, so a share hanging off a parent is never invisible", "delonix volume ls -A"),
        ],
        see_also: &["volume inspect", "volume describe", "volume create", "system df"],
    },
    Entry {
        path: "volume apply",
        group: "Declarative",
        ...
        see_also: &["stack apply", "stack plan", "volume create", "volume ls"],
    },
    Entry {

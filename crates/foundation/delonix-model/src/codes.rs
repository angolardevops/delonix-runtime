...
pub static CATALOG: &[Code] = &[
    ...
    code!(1341, "network.zone_provider_registration_refused", InvalidArgument, Network, 1,
    ...
    code!(1342, "network.no_zone_provider_configured", InvalidArgument, Network, 1,
    ...
    code!(1343, "network.ambiguous_zone_provider", InvalidArgument, Network, 1,

...
pub static CATALOG: &[Code] = &[
    ...
    code!(1341, "network.gateway_provider_registration_refused", InvalidArgument, Network, 1,
    ...
    code!(1530, "vm.proxmox_invalid_sdn_id", InvalidArgument, Vm, 1,
        "invalid Proxmox SDN zone or vnet id",
    ...
    code!(1531, "vm.proxmox_invalid_firewall_object_name", InvalidArgument, Vm, 1,
        "invalid Proxmox firewall alias or ipset name",
    ...
    code!(1532, "vm.proxmox_invalid_firewall_address", InvalidArgument, Vm, 1,
        "invalid Proxmox firewall address",
    ...
    code!(1533, "vm.proxmox_invalid_cidr", InvalidArgument, Vm, 1,
        "invalid Proxmox SDN subnet CIDR",
    ...
    code!(1534, "vm.proxmox_invalid_sdn_address", InvalidArgument, Vm, 1,
        "invalid Proxmox SDN address",
    ...
    code!(1535, "vm.proxmox_invalid_power_timeout", InvalidArgument, Vm, 1,
        "invalid Proxmox shutdown timeout",
    ...
    code!(1536, "vm.invalid_resize", InvalidArgument, Vm, 1,
        "invalid VM resize",
    ...
    code!(1537, "vm.invalid_cloud_init_change", InvalidArgument, Vm, 1,
        "invalid cloud-init change",
    ...
    code!(1538, "vm.invalid_move_target", InvalidArgument, Vm, 1,
        "invalid node to move the VM to",
    ...
    code!(4304, "network.opnsense_route_not_found", NotFound, Network, 4,
        "no such OPNsense API route",
    ...
    code!(5505, "vm.resize_needs_stopped", Conflict, Vm, 5,
        "the VM must be stopped to resize it",
    ...
    code!(5506, "vm.cloud_init_needs_stopped", Conflict, Vm, 5,
        "the VM must be stopped to change its cloud-init",
    ...
    code!(5507, "vm.move_refused", Conflict, Vm, 5,
        "the VM cannot be moved as asked",
    ...
    code!(6508, "vm.proxmox_datacenter_firewall_disabled", Unavailable, Vm, 69,
        "the Proxmox datacenter firewall is off",
    ...
    code!(6509, "vm.proxmox_backup_not_quiesced", Unavailable, Vm, 69,
        "the backup could not be taken with the guest's filesystem frozen",
    ...
    code!(9302, "network.opnsense_client_build", SystemFailure, Network, 1,
    ...
    code!(9308, "network.opnsense_decode", SystemFailure, Network, 1,
        "OPNsense response did not parse",
